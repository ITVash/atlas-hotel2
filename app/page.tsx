  ...
  return (
		<main className='relative overflow-x-hidden'>
			...
			<motion.div
				...
				className='flex fixed hover:bg-gray-200 justify-center items-center h-[35px] w-[35px] rounded-[40px] z-100 bottom-2 right-5 border-gray-500 border text-gray-500 cursor-pointer'
				onClick={() => {
			...
			<header
				className={cn(
					...
					scrolled
						? "bg-atlas-bg/95 backdrop-blur-2xl py-4 border-b border-atlas-ink/5 shadow-sm"
						: "bg-transparent",
				)}>
				{/* Left Side */}
				<div className='flex items-center gap-4 xl:gap-8 flex-1 justify-start'>
					<div className='flex items-center gap-4 xl:gap-6'>
						...
						<div
							...
							<button className='hover:text-atlas-red transition-colors'>
								RU
							</button>
				...
				<div className='flex items-center gap-4 md:gap-8 flex-1 justify-end'>
					<button
						...
						className={cn(
							...
							scrolled
								? "bg-atlas-ink text-atlas-bg hover:bg-atlas-red"
								: "bg-white text-atlas-ink hover:bg-atlas-red hover:text-white",
						)}>
						Забронировать
					</button>
					<button
						...
						className={cn(
							...
							scrolled
								? "text-atlas-ink hover:text-atlas-red"
								: "text-white hover:text-atlas-red drop-shadow-sm",
						)}>
						<span className='hidden md:block font-sans text-[10px] tracking-[0.3em] uppercase opacity-80 group-hover:opacity-100'>
							Меню
						</span>
				...
				{isMenuOpen && (
					<motion.div
						...
						<div className='mt-auto pt-12 border-t border-atlas-ink/10'>
							<p className='font-sans text-[10px] tracking-widest uppercase opacity-40 mb-4'>
								Связаться с нами
							</p>
								...
								<motion.div
									...
									<div className='flex-1 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 w-full relative z-10'>
										<div className='space-y-3 group/input cursor-pointer p-4 -m-4 rounded-xl hover:bg-white/5 transition-colors'>
											<label className='font-sans text-[9px] md:text-[10px] tracking-widest uppercase text-white/60 group-hover/input:text-white/80 transition-colors'>
												Заезд — Выезд
											</label>
											<div className='flex items-center justify-between border-b border-white/20 pb-2 group-hover/input:border-atlas-red transition-colors text-white'>
												...
												<Calendar
													size={16}
													strokeWidth={1}
													className='text-atlas-red group-hover/input:scale-110 transition-transform'
												/>
											</div>
										</div>
										<div className='space-y-3 group/input cursor-pointer p-4 -m-4 rounded-xl hover:bg-white/5 transition-colors'>
									...
									<div className='lg:w-64 flex items-start gap-3 text-[8px] md:text-[9px] leading-relaxed text-white/60 uppercase tracking-wider relative z-10 mt-4 lg:mt-0'>
										...
										<span className='text-left'>
											...
											<a
												href='#'
												className='underline hover:text-atlas-red transition-colors'>
												ФЗ-152
											</a>
										</span>
									</div>
			...
			<section
				id='О нас'
				className='py-[100px] md:py-[150px] px-6 md:px-12 bg-atlas-bg relative overflow-hidden'>
				<div className='max-w-7xl mx-auto grid lg:grid-cols-12 gap-16 lg:gap-8 items-center parallax-container'>
					<div className='lg:col-span-5 relative'>
						<div className='absolute -left-12 top-1/2 -translate-y-1/2 -rotate-90 origin-center hidden lg:block z-10'>
							<span className='font-sans text-[10px] tracking-[0.4em] uppercase opacity-40 whitespace-nowrap'>
						...
						<div className='absolute -bottom-8 -right-8 bg-white p-8 shadow-xl rounded-xl hidden md:block reveal-text z-20'>
							<p className='font-serif text-6xl text-atlas-red leading-none mb-2'>
								10+
							</p>
					...
					<div className='lg:col-span-6 lg:col-start-7 space-y-12'>
						<FadeIn>
							<h2 className='font-serif text-4xl sm:text-5xl md:text-7xl leading-tight relative break-words'>
								<span className='absolute -top-16 -left-8 text-[120px] font-serif text-atlas-ink/5 select-none z-0 hidden md:block'>
									2013
								</span>
								<span className='relative z-10'>
									Наследие <br />{" "}
									<i className='font-light text-atlas-red'>гостеприимства</i>
								</span>
							</h2>
						</FadeIn>
						<FadeIn
							delay={0.1}
							className='font-sans text-sm md:text-base leading-relaxed text-atlas-ink/80 space-y-6'>
							<p>
								Атлас Донецк – отель, который соответствует всем международным
								стандартам и предлагающий полный набор услуг для полноценного
								отдыха и эффективной работы: 164 комфортабельных номера,
								рестораны, в том числе открытая терраса, лаунж бар, спа и фитнес
								комплекс с бассейном, салон красоты, комната переговоров,
								конференц и банкетные залы.
							</p>
							<p>
								Отель находится на живописной набережной р. Кальмиус, в
								центральной части города, вблизи от стадиона &quot;Донбасс
								Арена&quot;, ледовой арены &quot;Дружба&quot;, офисов крупнейших
								компаний Донецка, а также развитой сети городского транспорта.
								Не все отели Донецка имеют такое удобное расположение как Атлас,
								которое идеально подходит для отдыха и деловых встреч.
							</p>
							<p>
								Наши номера оборудованы согласно всем современным требованиям.
								Выдержанные тона интерьера, комфортабельная кровать, удобное
								рабочее место, бесплатный Wi-Fi, превосходный душ обеспечат Вам
								максимально комфортное проживание в Донецке.
							</p>
						</FadeIn>
						<FadeIn
							delay={0.2}
							className='flex flex-wrap gap-8 md:gap-12 pt-8 border-t border-atlas-ink/10'>
							<div>
								<p className='font-serif text-3xl md:text-4xl mb-1'>164</p>
								<p className='font-sans text-[9px] md:text-[10px] tracking-widest uppercase opacity-40'>
									Номера
								</p>
							</div>
							<div>
			...
			<section
				id='Инфраструктура'
				className='bg-atlas-ink text-atlas-bg py-[100px] md:py-[150px] px-6 md:px-12'>
				<div className='max-w-screen-2xl mx-auto'>
					<FadeIn className='flex flex-col md:flex-row justify-between items-end mb-24 gap-8'>
						<h2 className='font-serif text-4xl sm:text-6xl md:text-8xl break-words'>
							Мир <i className='font-light'>Атласа</i>
						</h2>
						<p className='font-sans text-[10px] tracking-widest sm:tracking-[0.3em] uppercase opacity-40 max-w-xs text-left md:text-right'>
							Единый комплекс для отдыха, работы и вдохновения в самом сердце
							города.
						</p>
					</FadeIn>
					...
					<div className='grid grid-cols-1 md:grid-cols-12 gap-8'>
						...
						<FadeIn
							delay={0.1}
							className='md:col-span-7 group relative aspect-video overflow-hidden cursor-pointer'>
							<Image
								src='/fitness.jpg'
								alt='SPA'
								fill
								...
								onClick={() =>
									setInfraModal({
										...
										details: (
											<div>
												<p className='mb-3'>
													Атлас Фитнес и Спа - трехэтажный фитнес и спа комплекс
													класса «люкс» в центре Донецка, в котором сочетаются
													качество, современные технологии и необыкновенный
													комфорт.
												</p>
												<p className='mb-3'>
													Комплекс предлагает Вам воспользоваться полным набором
													услуг для поддержания здоровья и красоты. Atlas
													Fitness&Spa отличает уютная, расслабляющая атмосфера и
													непревзойденный комфорт. К Вашим услугам плавательный
													бассейн, тренажерный зал, зал единоборств, массажные
													кабинеты. Великолепный интерьер, лучшее оборудование и
													европейский сервис позволят Вам и Вашим близким в
													полной мере отдохнуть от городской суеты и окунутся в
												...
												<div className='flex justify-between gap-4 flex-col md:flex-row'>
													...
													<div className='flex flex-col flex-1'>
														...
														<p>
															На первом этаже нашего комплекса расположена
															аква-зона, где кроме, великолепного бассейна Вас
															ждет классическая римская парная, бутик Atlas
															Home&Spa с товарами от всемирно известных брендов
															и уютный фреш-бар с фитнес-коктейлями. Для самых
															маленьких мы с удовольствием предложим развивающую
															детскую комнату. Atlas Fitness&Spa - это
															увлекательный и здоровый семейный досуг.
														</p>
													</div>
												</div>
												...
												<div className='flex justify-between gap-4 flex-col md:flex-row'>
													...
													<div className='flex flex-col flex-1'>
														...
														<p>
															Второй этаж комплекса Atlas Fitness&Spa
															представляет для Вас возможность воспользоваться
															просторным тренажерным залом, оборудованным
															современными силовыми и кардио-тренажерами, залом
															единоборств и кабинетом фитнес-диагностики. В зале
															единоборств Вы сможете посетить увлекательные
															тренировки по айкидо, джиу-джитсу и боксу.
															Уникальный прибор TANITA в кабинете
															фитнес-диагностики поможет Вам определить
												...
												<div className='flex justify-between gap-4 flex-col md:flex-row'>
													...
													<div className='flex flex-col flex-1'>
														...
														<p>
															Зона красоты и релаксации, расположенная на
															третьем этаже комплекса. Предлагает Вам целый
															комплекс услуг массажных кабинетов. Здесь для Вас
															представлены эксклюзивные спа-дуэты для парных
															процедур, единственный в Донецке коллагенарий -
															аппарат для омоложения кожи лица и тела, залы
															аэробики и пилатес, банный комплекс и студия
															красоты. Специально разработанные эффективные
															индивидуальные программы оздоровления и омоложения
															организма помогут Вам получить незабываемое
															удовольствие от посещения зоны красоты и здоровья.
														</p>
													</div>
												</div>
												<hr className='text-gray-200 mb-4 mt-4' />
								...
								<div className='flex justify-between items-end'>
									<div>
										...
										<p className='font-sans text-[9px] md:text-[10px] tracking-widest uppercase opacity-60 max-w-sm'>
											Тренажерный зал, бассейн, римская парная и эксклюзивные
											СПА-ритуалы.
										</p>
									</div>
											...
											onClick={() =>
												setInfraModal({
													...
													details: (
														<div>
															<p className='mb-3'>
																Атлас Фитнес и Спа - трехэтажный фитнес и спа
																комплекс класса «люкс» в центре Донецка, в
																котором сочетаются качество, современные
																технологии и необыкновенный комфорт.
															</p>
															<p className='mb-3'>
																Комплекс предлагает Вам воспользоваться полным
																набором услуг для поддержания здоровья и
																красоты. Atlas Fitness&Spa отличает уютная,
																расслабляющая атмосфера и непревзойденный
																комфорт. К Вашим услугам плавательный бассейн,
																тренажерный зал, зал единоборств, массажные
																кабинеты. Великолепный интерьер, лучшее
																оборудование и европейский сервис позволят Вам и
																Вашим близким в полной мере отдохнуть от
																городской суеты и окунутся в мир гармонии и
																здоровья.
															</p>
															<hr className='text-gray-200 mb-4' />
															<div className='flex justify-between gap-4  flex-col md:flex-row'>
																...
																/>
																<div className='flex flex-col flex-1'>
																	<h4 className='text-atlas-red'>
																		Первый этаж
																	</h4>
																	<p>
																		На первом этаже нашего комплекса расположена
																		аква-зона, где кроме, великолепного бассейна
																		Вас ждет классическая римская парная, бутик
																		Atlas Home&Spa с товарами от всемирно
																		известных брендов и уютный фреш-бар с
																		фитнес-коктейлями. Для самых маленьких мы с
																		удовольствием предложим развивающую детскую
																		комнату. Atlas Fitness&Spa - это
																		увлекательный и здоровый семейный досуг.
																	</p>
																</div>
															</div>
															...
															<div className='flex justify-between gap-4 flex-col md:flex-row'>
																...
																<div className='flex flex-col flex-1'>
																	...
																	<p>
																		Второй этаж комплекса Atlas Fitness&Spa
																		представляет для Вас возможность
																		воспользоваться просторным тренажерным
																		залом, оборудованным современными силовыми и
																		кардио-тренажерами, залом единоборств и
																		кабинетом фитнес-диагностики. В зале
																		единоборств Вы сможете посетить
																		увлекательные тренировки по айкидо,
																		джиу-джитсу и боксу. Уникальный прибор
																		TANITA в кабинете фитнес-диагностики поможет
																		Вам определить состояние своего здоровья.
																	</p>
																</div>
															</div>
															<hr className='text-gray-200 mb-4 mt-4' />
															...
															<div className='flex justify-between gap-4 flex-col md:flex-row'>
																...
																<div className='flex flex-col flex-1'>
																	...
																	<p>
																		Зона красоты и релаксации, расположенная на
																		третьем этаже комплекса. Предлагает Вам
																		целый комплекс услуг массажных кабинетов.
																		Здесь для Вас представлены эксклюзивные
																		спа-дуэты для парных процедур, единственный
																		в Донецке коллагенарий - аппарат для
																		омоложения кожи лица и тела, залы аэробики и
																		пилатес, банный комплекс и студия красоты.
																		Специально разработанные эффективные
																		индивидуальные программы оздоровления и
																		омоложения организма помогут Вам получить
																		незабываемое удовольствие от посещения зоны
																		красоты и здоровья.
																	</p>
																</div>
															</div>
						...
						<FadeIn
							delay={0.2}
							className='md:col-span-5 group relative aspect-[4/5] overflow-hidden cursor-pointer'>
							<Image
								src='/restaurant.jpg'
								alt='Restaurant'
								fill
								...
								onClick={() =>
									setInfraModal({
										...
										details: (
											<div>
												<p className='mb-3'>
													Ресторанный комплекс «Атлас» в Донецке - это
													прекрасная возможность провести деловые переговоры,
													приятно совмещая их с вкусным обедом, а после работы
													отлично провести вечер и забыть о будничной городской
													суете.
												</p>
												<hr className='text-gray-200 mb-4' />
												<div className='flex justify-between gap-4 flex-col md:flex-row'>
													...
													<div className='flex flex-col flex-1'>
														...
														<p className='mb-5'>
															Насладитесь легкой и непринужденной атмосферой
															двух залов ресторана, а также оригинальным
															интерьером банкетной комнаты «Библиотека».
															Отведайте европейскую и турецкую кухни. Порадуйте
															себя отличной винной картой, разнообразием
															коктейлей. Добро пожаловать в ресторан «Атлас»!
														</p>
														<b className='mb-5'>
															Кухня разных стран, отличная винная карта,
															располагающая атмосфера.
														</b>
														<p className='mb-5'>
															Каждое утро ресторан «Атлас» сервирует вкусные и
															разнообразные завтраки для своих гостей: ароматный
															кофе и чай, горячие блюда, свежие фрукты и овощи,
															каши, а также выпечка и кондитерские изделия
															собственного приготовления. Гостям подается два
															вида завтрака: завтрак «Шведский стол» и
															«Континентальный».
														</p>
														<p className='mb-5'>
															<b>«Континентальный» завтрак</b> - классический
															европейский завтрак, который включает блюдо из
															яиц, бекон, ветчину или сосиски, гарниры на выбор,
															сыр, тосты, соки, а также чай или кофе.
														</p>
														<p className='mb-5'>
															<b>Завтрак «Шведский стол»</b>состоит из широкого
															выбора блюд и напитков: свежие фрукты и овощи,
															сырное ассорти и мясная гастрономия, сезонные
															салаты, творог, йогурты, блюда из яиц на Ваш
															выбор, приготовленные тут же на горячей станции,
															горячие овощные, рыбные и мясные блюда, свежая
															выпечка и фирменные кондитерские изделия,
															различные виды кофе и чая. Для детей до 7 лет –
															завтрак бесплатный, с 7-го летнего возраста
															стоимость завтрака оплачивается в полном
															размере.{" "}
														</p>
														<p className='mb-5'>
											...
											<div>
												...
												<div className='flex justify-between gap-4 flex-col md:flex-row'>
													...
													<div className='flex flex-col flex-1'>
														...
														<p className='mb-5'>
															Мы приглашаем Вас в новый ресторан, расположенный
															на третьем этаже гостиницы. Здесь Вы можете
															попробовать новое меню, особенностью которого
															являются блюда, приготовленные в испанской печи
															«Хоспер» (Josper). В ней мясо, рыба и овощи
															готовятся на древесном угле, без добавления жиров
															и масла, что позволяет сохранить полезные свойства
															и витамины продуктов, а блюда имеют аппетитный
															аромат барбекю. Мы также предлагаем Вам отведать
															такие виды рыб, которые сложно найти в других
															ресторанах Донецка. Добро пожаловать и приятного
															Вам аппетита!
														</p>
														<b>
															Ароматные блюда из печи «Хоспер» и прекрасное
															обслуживание.
														</b>
													</div>
												</div>
											...
											<div>
												...
												<div className='flex justify-between gap-4 flex-col md:flex-row'>
													...
													<div className='flex flex-col flex-1'>
														...
														<p className='mb-5'>
															Стильный, современный бар с отличным меню и
															безупречным обслуживанием. Вашему вниманию
															предлагаются закуски, восхитительные десерты,
															разнообразные крепкие и безалкогольные напитки,
															коктейли; обширная кофейная и чайная карты.
															Вечерами под аккомпанемент диджейских сэтов и
															лаунж-музыки можно расслабиться и даже
															потанцевать. Желаем Вам отличного настроения!
														</p>
														<b>
															Стиль, зажигательная музыка и коктейли – все для
															Вашего настроения.
														</b>
													</div>
												</div>
			...
			<section
				id='Номера'
				className='py-[100px] md:py-[150px] bg-atlas-bg px-6 md:px-12'>
				<div className='max-w-7xl mx-auto'>
					<FadeIn className='mb-16 md:mb-24'>
						<h2 className='font-serif text-4xl sm:text-6xl md:text-8xl mb-8 break-words'>
							Ваш <br /> <i className='font-light'>покой</i>
						</h2>
			...
			<section id='Мероприятия' className='py-[100px] md:py-[150px]'>
				<div className='relative w-full h-[40vh] md:h-[60vh] mb-16 md:mb-24 overflow-hidden'>
					...
					<div className='absolute inset-0 bg-atlas-ink/40 flex items-center justify-center'>
						<h2 className='font-serif text-4xl sm:text-6xl md:text-9xl text-white tracking-tighter break-words text-center px-4'>
							События
						</h2>
					</div>
				</div>
				...
				<div className='max-w-7xl mx-auto px-6'>
					<div className='flex flex-col gap-24 mb-32'>
						<FadeIn className='space-y-8 max-w-3xl'>
							<h3 className='font-serif text-3xl sm:text-4xl md:text-5xl leading-tight break-words'>
								Пространство для <br />{" "}
								<i className='font-light'>важных решений</i>
							</h3>
							<p className='font-sans text-xs md:text-sm leading-loose text-atlas-ink/60'>
								Мы предлагаем конференц-залы, комнаты переговоров и залы
								&quot;Классик&quot; и &quot;Модерн&quot;. Идеальная акустика,
								современное оборудование и безупречный кейтеринг от шеф-повара.
							</p>
							<ul className='grid grid-cols-1 sm:grid-cols-2 gap-4 font-sans text-[9px] md:text-[10px] tracking-widest uppercase'>
								<li className='flex items-center gap-2'>
									<ChevronRight size={12} className='text-atlas-red' /> Зал
									&quot;Классик&quot;
								</li>
								<li className='flex items-center gap-2'>
									<ChevronRight size={12} className='text-atlas-red' /> Зал
								...
								<li className='flex items-center gap-2'>
									<ChevronRight size={12} className='text-atlas-red' />{" "}
									Банкетный зал
								</li>
								<li className='flex items-center gap-2'>
									<ChevronRight size={12} className='text-atlas-red' />{" "}
						...
						<FadeIn className='space-y-8'>
							<h3 className='font-serif text-3xl sm:text-4xl md:text-5xl leading-tight break-words'>
								Пакеты для <br /> <i className='font-light'>молодоженов</i>
							</h3>
							<p className='font-sans text-xs md:text-sm leading-loose text-atlas-ink/60 max-w-3xl'>
								Свадебные пакеты в отеле Атлас.
								<br />
								<br />
								Незабываемым завершением свадебного торжества станет
								романтический вечер, проведенный в уютном номере отеля Атлас.
							</p>
							<div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
								<div className='p-6 sm:p-8 border border-atlas-ink/10 hover:border-atlas-red hover:shadow-2xl transition-all duration-500 group bg-white hover:-translate-y-2'>
									<p className='font-sans text-[9px] md:text-[10px] tracking-widest uppercase opacity-40 mb-4 group-hover:text-atlas-red group-hover:opacity-100 transition-colors'>
										Свадебный пакет &quot;Полулюкс&quot;
									</p>
									...
									<ul className='text-[11px] opacity-60 mb-6 leading-relaxed space-y-2 list-disc pl-4'>
										<li>
											Украшение номера категории &quot;Полулюкс&quot; свадебными
											аксессуарами;
										</li>
										<li>
											Бесплатный ранний заезд (по предварительному
											согласованию);
										</li>
										<li>
											Сертификат на проживание со скидкой 50% в годовщину
											свадьбы;
										</li>
										<li>
											Бесплатный поздний выезд (по предварительному
											согласованию);
										</li>
										<li>
											Посещение тренажерного зала, бассейна и римской парной;
										</li>
										<li>
											Комплимент от отеля: пирожные &quot;Шу&quot;, шампанское и
											фрукты;
										</li>
										<li>
											Единоразовая скидка 20% на ужин в ресторане, сертификат на
											3 месяца;
										</li>
										<li>
											Единоразовая 20% скидка на процедуры в СПА (сертификат на
											3 месяц).
										</li>
									</ul>
									<button
								...
								<div className='p-6 sm:p-8 border border-atlas-ink/10 hover:border-atlas-red hover:shadow-2xl transition-all duration-500 group bg-white hover:-translate-y-2'>
									<p className='font-sans text-[9px] md:text-[10px] tracking-widest uppercase opacity-40 mb-4 group-hover:text-atlas-red group-hover:opacity-100 transition-colors'>
										Свадебный пакет &quot;Люкс&quot;
									</p>
									<p className='font-serif text-3xl mb-4'>18 000 ₽</p>
									<ul className='text-[11px] opacity-60 mb-6 leading-relaxed space-y-2 list-disc pl-4'>
										<li>
											Украшение номера категории &quot;Люкс&quot; свадебными
											аксессуарами;
										</li>
										<li>
											Бесплатный ранний заезд (по предварительному
										...
										<li>
											Комплимент от отеля: пирожные &quot;Шу&quot;, фрукты,
											шампанское;
										</li>
										<li>
											Единоразовая скидка 20% на ужин в ресторане, сертификат на
			...
			<section id='Новости' className='py-[100px] md:py-[150px] bg-[#F0EFEA]'>
				<div className='max-w-7xl mx-auto px-6'>
					<div className='flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-8'>
						<h2 className='font-serif text-4xl sm:text-5xl md:text-6xl leading-tight break-words'>
							Журнал <i className='font-light'>Атлас</i>
						</h2>
						<a
							href='#'
							className='font-sans text-[10px] tracking-widest uppercase border-b border-atlas-ink pb-1 hover:text-atlas-red hover:border-atlas-red transition-all'>
							Все новости
						</a>
					</div>
					<div className='grid md:grid-cols-3 gap-12 md:gap-8 lg:gap-12'>
						{[
							...
							<div key={i} className='group cursor-pointer'>
								...
								<p className='font-sans text-[9px] md:text-[10px] tracking-widest uppercase opacity-40 mb-3 group-hover:text-atlas-red transition-colors'>
									{news.date}
								</p>
								<h3 className='font-serif text-xl md:text-2xl mb-4 leading-snug group-hover:text-atlas-red transition-colors'>
									{news.title}
								</h3>
			...
			<section
				id='Контакты'
				className='py-[100px] md:py-[150px] bg-atlas-ink text-white overflow-hidden relative map-section'>
					...
					<div className='grid lg:grid-cols-12 gap-16 lg:gap-24 items-center'>
						<div className='lg:col-span-5 relative z-10'>
							<FloatingElement delay={0.2}>
								<span className='font-sans text-[10px] tracking-widest sm:tracking-[0.4em] uppercase opacity-40 mb-8 block reveal-text'>
									Местоположение
								</span>
								<h2 className='font-serif text-4xl sm:text-6xl md:text-8xl mb-16 leading-tight reveal-text break-words'>
									Сердце <br />{" "}
									<i className='font-light text-atlas-red'>Донецка</i>
								</h2>
							</FloatingElement>
							...
							<div className='space-y-12 reveal-text'>
								<div className='group cursor-pointer border-b border-white/10 pb-8'>
									...
									<p className='font-serif text-2xl md:text-3xl leading-snug group-hover:pl-4 transition-all duration-500'>
										бульвар Шевченко, 20 <br /> Донецк, 283015
									</p>
								</div>
									...
									<div className='group cursor-pointer'>
										...
										<div className='space-y-1 group-hover:pl-2 transition-all duration-500'>
											<p className='font-serif text-xl'>
												info@atlas-donetsk.ru
											</p>
											<p className='font-serif text-xl opacity-60'>
												sales@atlas-donetsk.ru
											</p>
										</div>
									</div>
								</div>
						...
						<div className='lg:col-span-7 relative aspect-[4/3] lg:aspect-auto lg:h-[800px] map-container'>
							<div className='relative h-full w-full overflow-hidden rounded-2xl border border-white/10 shadow-2xl group'>
								...
								<iframe
									...
									className='absolute inset-0 w-full h-full grayscale opacity-80 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-1000'></iframe>
							</div>
						</div>
					</div>
				</div>
				...
				<div className='max-w-screen-2xl mx-auto'>
					<div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-16 mb-24'>
						<div className='md:col-span-1'>
							...
							<p className='font-sans text-xs leading-loose opacity-60 max-w-xs'>
								Премиальный гостинично-ресторанный комплекс в самом сердце
								Донецка. Искусство гостеприимства с 2013 года.
							</p>
						</div>
						<div>
							<h4 className='font-sans text-[10px] tracking-widest sm:tracking-[0.3em] uppercase mb-8 opacity-60'>
								Навигация
							</h4>
							<ul className='space-y-4 font-serif text-xl'>
								<li>
									<a href='#О нас' className='hover:italic transition-all'>
										О нас
									</a>
								</li>
								<li>
									<a href='#Номера' className='hover:italic transition-all'>
										Номера
									</a>
								</li>
								<li>
						...
						<div>
							...
							<p className='text-xs opacity-60 mb-6'>
								Будьте в курсе эксклюзивных предложений и новостей Атласа.
							</p>
							<form className='flex border-b border-white/20 pb-2 group'>
								...
								<button
									type='submit'
									disabled={!footerFzConsent}
									className='group-hover:translate-x-1 transition-transform disabled:opacity-50 disabled:group-hover:translate-x-0'>
									<ArrowRight size={16} />
								</button>
							</form>
							<div className='flex items-start gap-2 mt-4 text-[9px] opacity-60 uppercase tracking-wider'>
								<button
									...
									{footerFzConsent && (
										<Check size={8} className='text-atlas-red' />
									)}
								</button>
								<span className='text-left'>
									Согласен с{" "}
					...
					<div className='pt-12 border-t border-white/10 flex flex-col lg:flex-row justify-between gap-8 font-sans text-[10px] tracking-widest uppercase opacity-40'>
						<div className='flex flex-col gap-3'>
							...
							<p className='normal-case tracking-normal text-xs opacity-80'>
								Юридический адрес: РФ, ДНР, г. Донецк, б-р Шевченко, д. 20
							</p>
						</div>
				...
				{!cookieAccepted && (
					<motion.div
						...
						<p className='font-sans text-[10px] leading-relaxed mb-6 tracking-wider uppercase opacity-60'>
							...
							файлов cookie и пользовательских данных в целях функционирования
							сайта в соответствии с Политикой обработки персональных данных
							(ФЗ-152).
						</p>
						<button
